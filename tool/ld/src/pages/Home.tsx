...
export default function Home() {
    ...
    const {
        ...
        finalVolume,
        recordingTime
    } = useAudioRecorder(setIsRecording);
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col items-center justify-center p-6">
            {}
            <motion.div
                initial={{
                    opacity: 0,
                ...
                <h1 className="text-3xl font-semibold text-gray-900 mb-2">早读助手</h1>
                ...
                {!showResult ? <>
                    ...
                    <motion.div
                        ...
                        {isRecording ? <motion.button
                            ...
                            <i className="fas fa-microphone mr-2"></i>开始
                                            </motion.button>}
                        {!isRecording && <motion.button
                            whileHover={{
                                scale: 1.05
                            ...
                            <i className="fas fa-history mr-2"></i>历史
                                            </motion.button>}
                    </motion.div>
                    {}
                    ...
                    <motion.div
                        ...
                        <p
                            ...
                            }}>{formatDuration(totalDuration)}</p>
                    </motion.div>
                    {}
                    <motion.button
                        whileHover={{
                        ...
                        onClick={handleStartRecording}
                        className="px-8 py-3 bg-blue-500 text-white font-medium rounded-full shadow-lg hover:bg-blue-600 transition-all duration-300 flex items-center">
                        <i className="fas fa-redo mr-2"></i>重新开始
                                    </motion.button>
                </motion.div>}
            </motion.div>
            {}
